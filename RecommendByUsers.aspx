<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Client.Master" AutoEventWireup="true" CodeBehind="RecommendByUsers.aspx.cs" Inherits="fyp.RecommendByUsers" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <button class="btnRecommendUp btn-recommend active" title="Recommend">
        <i class="fa fa-arrow-up"></i>
        <span class="recommend-count"><%# Eval("RecommendedCount") %></span>
    </button>
    <button class="btnRecommendDown btn-recommend active" title="Not Recommend">
        <i class="fa fa-arrow-down"></i>
        <span class="recommend-count"><%# Eval("NotRecommendedCount") %></span>
    </button>
</div>
