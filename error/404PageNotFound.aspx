<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="404PageNotFound.aspx.cs" Inherits="fyp.error._404PageNotFound" %>
...
<div class="error">
  ...
  <div class="error__description">It looks like one of the  developers fell asleep</div>
    <form runat="server">
  <asp:button class="error__button error__button--active" runat="server" ID="btnHome" Text="HOME" OnClick="btnHome_Click"></asp:button>
        </form>
</div>
